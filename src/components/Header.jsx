...
const PerfilDefecto = styled.div`
  width: 60%;
  height: 100%;
  background: none;
  display: flex;
...
const Botones = styled.div`
  ...
  button:hover {
    border: 1px solid #04bb35;
    box-shadow: -2px 2px 1px #04bb35;
  }
`;

const RedesDatos = styled.div`
  width: 100%;
  height: 20%;
  display: flex;
  ...
  p:hover {
    filter: drop-shadow(-1px -1px 2px #04bb35);
  }
`;
